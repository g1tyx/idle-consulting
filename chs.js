...
var cnItems = {
    ...
    "- IMPORTANT -": "- 重要的 -",
    "A project management office is unavoidable.": "项目管理办公室是不可避免的。",
    "By starting this operation you will prestige!": "通过启动此操作，您将获得声望！",
    "Even more books, do we need a library?": "更多的书，我们需要图书馆吗？",
    "Have 604800 experience.": "有604800经验。",
    "In this operation you have access to: Junior & ": "在此操作中，您可以访问：初级人员 &",
    "It's a surprise mechanic.": "这是一个惊喜机制。",
    "More books.": "更多书籍。",
    "Only developers can finish a project but you need project management to guide them.": "只有开发人员才能完成一个项目，但您需要项目管理来指导他们。",
    "Operations": "操作",
    "Requirements for the next operation: Complete Operation #01, 5 contract breach & Ascension 10.": "下一次行动的要求：完成行动 #01、5 合同违约和提升 10。",
    "RESEARCH IS ENABLED!": "研究已启用！",
    "Result": "结果",
    "Revoke all of your contracts to unlock more contracts and operations.": "撤销所有合同以解锁更多合同和操作。",
    "The customer demands more KPI's.": "客户要求更多的 KPI。",
    "The deadline is tight but you can do it, just do it!": "截止日期很紧，但你可以做到，只要去做！",
    "This is the budget for the project, prestige to reallocate the budget.": "这是项目预算，威风重新分配预算。",
    "You ascend for the 5th time.": "你第 5 次登顶。",
    "You need to discuss this contract with your lawyer!": "您需要与您的律师讨论这份合同！",
    "You need to plan ahead...": "你需要提前计划...",
    "You revoked all of your contracts once. Unlock operation #01.": "你撤销了所有合同一次。 解锁操作 #01。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^You prestiged for the (.+) time.$/, '你声望了 $1 次。'],
    ...
    [/^(.+) Days$/, ' $1 天'],
    [/^\#(.+) Contract: (.+)$/, '\#$1 合同：$2'],
    [/^Requirements for the next operation: Complete Operation \#([\d\.,]+), ([\d\.,]+) contract breach \& Ascension ([\d\.,]+).$/, '下一次操作的要求：完成操作 \#$1，$2 合同违约 \& 转生 $3。'],
    [/^(.+)Operation \#(.+)$/, '$1 操作 \#$2'],
    [/^(.+) Breaks$/, ' $1 休息'],
    [/^(.+)1st Ascension$/, ' 第一次转生'],
    [/^(.+)Buy ([\d\.,]+)(.+)$/, ' 购买 $2 '],
